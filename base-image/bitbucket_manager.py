...
def bitbucket_manager(bitbucket_username, bitbucket_password, bitbucket_team, 
                      bitbucket_project_name, bitbucket_repository_name):
    ...
    project_response = requests.post(url="https://api.bitbucket.org/2.0/teams/{}/projects/".format(bitbucket_team),
                                     json=project_options, auth=bitbucket_auth)
